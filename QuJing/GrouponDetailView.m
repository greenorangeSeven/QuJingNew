...
@interface GrouponDetailView ()<UIWebViewDelegate, SGFocusImageFrameDelegate, MWPhotoBrowserDelegate>
{
    UserInfo *userInfo;
...
@implementation GrouponDetailView
