...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        Trade *trade = [trades objectAtIndex:row];
        NSString *pushDetailHtm = [NSString stringWithFormat:@"%@%@?accessId=%@&businessId=%@", api_base_url, htm_businessDetail , AccessId, trade.businessId];
        CommDetail2View *detailView = [[CommDetail2View alloc] init];
