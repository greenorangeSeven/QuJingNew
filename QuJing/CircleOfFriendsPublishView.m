...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[CameraImgCell class] forCellWithReuseIdentifier:CameraImgCellIdentifier];
...
{
    CameraImgCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CameraImgCellIdentifier forIndexPath:indexPath];
    if (!cell) {
        NSArray *objects = [[NSBundle mainBundle] loadNibNamed:@"CameraImgCell" owner:self options:nil];
        for (NSObject *o in objects) {
            if ([o isKindOfClass:[CameraImgCell class]]) {
                cell = (CameraImgCell *)o;
                break;
            }
        }
    }
    ...
    cell.cameraIv.image = repairImage;
